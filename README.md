...
<li><b>Speed:</b> All of the APIs (R, Python, and yes, Scala) are all communicating with the same API - specifically the Spark DataFrames API. This means that the execution speeds written in any of the three languages are functionally the same.</li>
